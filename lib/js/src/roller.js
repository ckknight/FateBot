...
function getMatchLength(match_) {
  return Caml_array.caml_array_get(match_, 0).length;
}

function diceExpMatcher(str) {
  return Utils.Option[/* map */5]((function (match_) {
                  var diceCount = Utils.$$parseInt(1, Caml_array.caml_array_get(match_, 1));
                  var match = Caml_array.caml_array_get(match_, 2).toLowerCase();
                  var dice;
                  switch (match) {
                    case "%" : 
                    ...
                    case "f" : 
                        ...
                        break;
                    default:
                      dice = Boolean(Caml_array.caml_array_get(match_, 4)) ? /* Dice */Block.__(1, [
                            diceCount,
                            Utils.$$parseInt(1, Caml_array.caml_array_get(match_, 3)),
                            Utils.$$parseInt(1, Caml_array.caml_array_get(match_, 4))
                          ]) : /* Dice */Block.__(1, [
                            diceCount,
                            1,
                            Utils.$$parseInt(6, Caml_array.caml_array_get(match_, 3))
                          ]);
                  }
                  return /* tuple */[
                          /* :: */[
                          ...
                          Caml_array.caml_array_get(match_, 0).length
                        ];
...
function constantMatcher(str) {
  return Utils.Option[/* map */5]((function (match_) {
                  var value = Utils.$$parseInt(0, Caml_array.caml_array_get(match_, 1));
                  return /* tuple */[
                          /* :: */[
...
function emojify(tokens, rolls) {
  return $$eval(tokens, rolls, "", (function (op, acc) {
                ...
                var partial_arg = min === -1 && max === 1 ? emojifyFateDie : (
                ...
                var array = rolls.map(Curry.__1(partial_arg));
