...
function parsePrefixedMessage(prefix, client, msg) {
  ...
  return Belt_Option.flatMap(__x === null ? /* None */0 : [__x], (function (match__) {
                ...
                switch (commandName) {
                  ...
                  case "tak" : 
                      var args$1 = args;
                      var __x$1 = args$1.match(new RegExp("^(place|move|show)\\b\\s*(.*)$", "i"));
  ...
  if (typeof command === "number") {
    switch (command) {
      ...
      case 5 : 
          ...
          return /* () */0;
      case 6 : 
          Discord.Message[/* reply */0](/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, showTak(takGame[0]), msg);
          return /* () */0;
    ...
    switch (command.tag | 0) {
      ...
      case 4 : 
          ...
          if (match.tag) {
            Discord.Message[/* reply */0](/* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, /* None */0, match[0], msg$10);
          } else {
            takGame[0] = match[0];
