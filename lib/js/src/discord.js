...
function TextBasedChannel() {
  var send = function ($staropt$star, nonce, embed, disableEveryone, $staropt$star$1, code, split, reply, content, t) {
    var tts = $staropt$star ? $staropt$star[0] : /* false */0;
    var files = $staropt$star$1 ? $staropt$star$1[0] : /* array */[];
    return Utils.promiseMap(Utils.magicAsArray)(t.send(content, {
                    tts: Js_boolean.to_js_boolean(tts),
                    nonce: Js_undefined.from_opt(nonce),
                    embed: Js_undefined.from_opt(embed),
                    disableEveryone: Js_undefined.from_opt(Utils.Option[/* map */5](Js_boolean.to_js_boolean)(disableEveryone)),
                    files: files,
                    code: Js_undefined.from_opt(code),
                    split: Js_undefined.from_opt(Utils.Option[/* map */5]((function (splitOptions) {
                                  return {
                                          maxLength: Js_undefined.from_opt(splitOptions[/* maxLength */0]),
                                          char: splitOptions[/* char */1],
                                          prepend: splitOptions[/* prepend */2],
                                          append: splitOptions[/* append */3]
                                        };
                                }))(split)),
                    reply: Js_undefined.from_opt(reply)
                  }));
  };
