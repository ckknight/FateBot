...
function attemptToPlace(board) {
  var match = board[/* status */5];
  if (match !== 4) {
    if (match >= 5) {
      return /* Error */Block.__(1, ["Black has already won"]);
    } else {
      return /* Ok */Block.__(0, [/* () */0]);
    }
  } else {
    return /* Error */Block.__(1, ["White has already won"]);
  }
}
...
function doPlace(stoneType, position, board) {
  var __x = attemptToPlace(board);
  var __x$1 = Belt_Result.flatMapU(__x, (function () {
          var position$1 = position;
          var board$1 = board;
          if (isPositionWithinBounds(position$1, board$1)) {
            return /* Ok */Block.__(0, [/* () */0]);
          } else {
            return /* Error */Block.__(1, ["position not within bounds"]);
          }
        }));
  var __x$2 = Belt_Result.flatMapU(__x$1, (function () {
          var position$1 = position;
          var board$1 = board;
          if (isPositionTaken(position$1, board$1)) {
            return /* Error */Block.__(1, ["position is already taken"]);
          } else {
            return /* Ok */Block.__(0, [/* () */0]);
          }
        }));
  return Belt_Result.flatMapU(__x$2, (function () {
                var match = board[/* status */5];
                var match$1;
                switch (match) {
                  case 0 : 
                ...
                if (match$1[1] && stoneType !== /* FlatStone */0) {
                  return /* Error */Block.__(1, ["a FlatStone must be placed initially"]);
                } else {
                  ...
                  return /* Ok */Block.__(0, [checkForWinner(Belt_Option.getExn(whoseTurn(board)), /* record */[
                                  /* boardSize */board[/* boardSize */0],
...
function attemptMove(board) {
  var match = board[/* status */5];
  if (match >= 2) {
    if (match >= 4) {
      return /* Error */Block.__(1, ["game has already been won"]);
    } else {
      return /* Ok */Block.__(0, [/* () */0]);
    }
  } else {
    return /* Error */Block.__(1, ["cannot move in the initial turns"]);
  }
}
...
function doMove(position, direction, leftStones, board) {
  var __x = attemptMove(board);
  return Belt_Result.flatMapU(__x, (function () {
                  ...
                  if (match) {
                    ...
                    if (stones[0][0] === playerColor) {
                      ...
                      if (match$1) {
                        ...
                        return /* Ok */Block.__(0, [checkForWinner(playerColor, /* record */[
                                        /* boardSize */board[/* boardSize */0],
                                        /* whitePiecesRemaining */board[/* whitePiecesRemaining */1],
                                        /* blackPiecesRemaining */board[/* blackPiecesRemaining */2],
                                        /* whiteCapstonesRemaining */board[/* whiteCapstonesRemaining */3],
                        ...
                        return /* Error */Block.__(1, ["cannot move there"]);
                      }
                    } else {
                      return /* Error */Block.__(1, ["Not the correct player"]);
                    }
                  } else {
                    return /* Error */Block.__(1, ["Not the correct player"]);
                  }
...
function dispatch(action, board) {
  ...
  return Belt_Result.mapU(__x, (function (board) {
                return /* record */[
                        /* boardSize */board[/* boardSize */0],
                        /* whitePiecesRemaining */board[/* whitePiecesRemaining */1],
                        /* blackPiecesRemaining */board[/* blackPiecesRemaining */2],
