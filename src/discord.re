...
module Collection = {
  ...
  [@bs.send.pipe: t('k, 'v)]
  external filter : ('v => bool) => t('k, 'v) = "";
  [@bs.send.pipe: t('k, 'v)]
  external filteri : ((. 'v, 'k) => bool) => t('k, 'v) = "filter";
  [@bs.send.pipe: t('k, 'v)]
  external filterArray : ('v => bool) => array('v) = "";
  [@bs.send.pipe: t('k, 'v)]
  external filterArrayi : ((. 'v, 'k) => bool) => array('v) = "filterArray";
  [@bs.send.pipe: t('k, 'v)] [@bs.return nullable]
  external find : ('v => bool) => option('v) = "";
  [@bs.send.pipe: t('k, 'v)] [@bs.return nullable]
  external findi : ((. 'v, 'k) => bool) => option('v) = "find";
  [@bs.send.pipe: t('k, 'v)] [@bs.return nullable]
  external findByProp : (string, 'a) => option('v) = "find";
  [@bs.send.pipe: t('k, 'v)]
  external findAll : (string, 'a) => array('v) = "";
  [@bs.send.pipe: t('k, 'v)] [@bs.return nullable]
  external findKey : ('v => bool) => option('k) = "";
  [@bs.send.pipe: t('k, 'v)] [@bs.return nullable]
  external findKeyi : ((. 'v, 'k) => bool) => option('k) = "findKey";
  [@bs.send.pipe: t('k, 'v)]
  external findKeyByProp : (string, 'a) => Js.null('k) = "findKey";
  [@bs.send] [@bs.return nullable]
  external first : t('k, 'v) => option('v) = "";
  [@bs.send.pipe: t('k, 'v)]
  external firstValues : int => array('v) = "first";
  [@bs.send] [@bs.return nullable]
  external firstKey : t('k, 'v) => option('k) = "";
  [@bs.send.pipe: t('k, 'v)]
  external firstKeys : int => array('k) = "firstKey";
  [@bs.send] external keyArray : t('k, 'v) => array('k) = "";
  [@bs.send] [@bs.return nullable]
  external last : t('k, 'v) => option('v) = "";
  [@bs.send.pipe: t('k, 'v)] external lastValues : int => array('v) = "last";
  [@bs.send] [@bs.return nullable]
  external lastKey : t('k, 'v) => option('k) = "";
  [@bs.send.pipe: t('k, 'v)]
  external lastKeys : int => array('k) = "lastKey";
  [@bs.send.pipe: t('k, 'v)] external map : ('v => 'x) => array('x) = "";
  [@bs.send.pipe: t('k, 'v)]
  external mapi : ((. 'v, 'k) => 'x) => array('x) = "map";
  [@bs.send] [@bs.return nullable]
  external random : t('k, 'v) => option('v) = "";
  [@bs.send.pipe: t('k, 'v)]
  external randomValues : int => array('v) = "random";
  [@bs.send] [@bs.return nullable]
  external randomKey : t('k, 'v) => option('k) = "";
  [@bs.send.pipe: t('k, 'v)]
  external randomKeys : int => array('k) = "randomKey";
  [@bs.send.pipe: t('k, 'v)]
  external reduce : ((. 'a, 'v) => 'a, 'a) => 'a = "";
  [@bs.send.pipe: t('k, 'v)]
  external reducei : ((. 'a, 'v, 'k) => 'a, 'a) => 'a = "reduce";
  [@bs.send.pipe: t('k, 'v)] external some : ('v => bool) => bool = "";
  [@bs.send.pipe: t('k, 'v)]
  external somei : ((. 'v, 'k) => bool) => bool = "some";
  [@bs.send] external sort : t('k, 'v) => t('k, 'v) = "";
  [@bs.send.pipe: t('k, 'v)]
  external sortWith : ((. 'v, 'v) => int) => t('k, 'v) = "sort";
  external sortWithi : ((. 'v, 'v, 'k, 'k) => int) => t('k, 'v) = "sort";
};
...
module Client = {
  ...
  external readyAt : t => option(Js.Date.t) = "";
  [@bs.get] [@bs.return nullable]
  ...
  [@bs.get] [@bs.return nullable]
  external user : t => option(clientUser) = "";
  ...
  [@bs.send.pipe: t]
  external fetchInvite : string => Js.Promise.t(invite) = "";
  [@bs.send.pipe: t]
  external fetchUser : snowflake => Js.Promise.t(user) = "";
  ...
  [@bs.send.pipe: t]
  external fetchWebhookWithToken :
    (snowflake, string) => Js.Promise.t(webhook) =
    "fetchWebhook";
  [@bs.send.pipe: t]
  external generateInvite : int => Js.Promise.t(string) = "";
...
module Message = {
  ...
  [@bs.send.pipe: t]
  external isMemberMentioned : user => Js.Promise.t(t) = "";
  [@bs.send.pipe: t]
  ...
  [@bs.send.pipe: t]
  external react : emoji => Js.Promise.t(messageReaction) = "";
  [@bs.send.pipe: t]
...
module Guild = {
  ...
  [@bs.get] [@bs.return nullable]
  external afkChannelId : t => option(string) = "";
  [@bs.get] [@bs.return nullable]
  external afkTimeout : t => option(float) = "";
  [@bs.get] [@bs.return nullable]
  ...
  [@bs.get] [@bs.return nullable]
  external splashURL : t => option(string) = "";
  [@bs.get] [@bs.return nullable]
...
module GuildChannel = {
  module Impl = (C: {type t;}) => {
    ...
    [@bs.send.pipe: C.t]
    external deleteWithReason : string => Js.Promise.t(C.t) = "delete";
    let delete = (~reason=?, t) =>
      switch (reason) {
      | None => delete(t)
    ...
    [@bs.send.pipe: C.t]
    external edit : channelData => Js.Promise.t(C.t) = "";
    [@bs.send.pipe: C.t]
...
module TextChannel = {
  module Impl = (C: {type t;}) => {
    ...
    [@bs.get]
    external members : C.t => collection(snowflake, guildMember) = "";
    [@bs.get] external nsfw : C.t => bool = "";
    [@bs.get] [@bs.return nullable]
    external topic : C.t => option(string) = "";
    [@bs.get] external typing : C.t => bool = "";
    [@bs.get] external typingCount : C.t => int = "";
...
module User = {
  module Impl = (U: {type t;}) => {
    ...
    [@bs.get] [@bs.return nullable]
    external note : U.t => option(string) = "";
...
module MessageEmbed = {
  ...
  [@bs.get] external createdTimestamp : t => float = "";
  [@bs.get] [@bs.return nullable]
  external description : t => option(string) = "";
...
module FileOptions = {
  ...
  type jsFileOptions = {
    ...
    "name": Js.undefined(string) /* default: "file.jpg" */
  };
