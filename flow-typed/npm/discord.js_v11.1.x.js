// flow-typed signature: 1dedd50db50a666b5feeb19272ba650a
// flow-typed version: 88cf1a4327/discord.js_v11.1.x/flow_>=v0.34.x
...
declare module 'discord.js' {
  ...
  declare export class ClientUser extends User {
    ...
    createGroupDM(
      recipients: GroupDMRecipientOptions[],
  ...
  declare class Collector<K, V> {
    ...
    on(
      event: 'collect',
      listener: (element: V, collector: Collector<K, V>) => void,
    ): this,
    on(
      event: 'end',
  ...
  declare export class DMChannel extends Channel {
    constructor(client: Client, data: Object): this,
  ...
  declare export class GroupDMChannel extends Channel {
    constructor(client: Client, data: Object): this,
  ...
  declare export class Guild {
    ...
    ban(
      user: UserResolvable,
      deleteDays?: number,
    ): Promise<GuildMember | User | string>,
    createChannel(
      name: string,
      type: 'text' | 'voice',
      overwrites?: PermissionOverwrites[] | Object[],
  ...
  declare export class ReactionCollector extends Collector<
    Snowflake,
    MessageReaction,
  > {
    constructor(
    ...
    ): CollectorHandler<Snowflake, MessageReaction>,
  ...
  declare export class TextChannel extends GuildChannel {
    constructor(guild: Guild, data: Object): this,
    lastMessageID: string,
    members: Collection<Snowflake, GuildMember>,
    messages: Collection<Snowflake, Message>,
  ...
  declare export class Util {
    ...
    escapeMarkdown(
      text: string,
      onlyCodeBlock?: boolean,
      onlyInlineCode?: boolean,
    ): string,
  ...
  declare class TextBasedChannelFields {
    ...
    bulkDelete(
      messages: Collection<string, Message> | Message[] | number,
      filterOld?: boolean,
    ): Promise<Collection<string, Message>>,
    createCollector(
      filter: CollectorFilter,
